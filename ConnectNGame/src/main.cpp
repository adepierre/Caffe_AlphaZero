...
#include "ConnectNState.h"
#include "AlphaZero.h"

//Common flags
DEFINE_int32(train, 0, "Whether we want to train the net or test it");
DEFINE_int32(board_width, 7, "Width of the board");
DEFINE_int32(board_height, 6, "Height of the board");
...
int main(int argc, char** argv)
{
	...
	ConnectNState<int>::SetBoardWidth(FLAGS_board_width);
	ConnectNState<int>::SetBoardHeight(FLAGS_board_height);
	ConnectNState<int>::SetAlignedToWin(FLAGS_aligned_to_win);
	...
	{
		AlphaZero<ConnectNState<int>, int> tester(FLAGS_model_file, FLAGS_trained_weights, FLAGS_num_playouts, FLAGS_c_puct);
