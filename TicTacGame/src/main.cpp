...
int main(int argc, char** argv) 
{
	...
	if (FLAGS_train)
	{
		AlphaZero<TicTacState<int>, int> trainer(FLAGS_solver_file, FLAGS_snapshot, FLAGS_num_playouts, FLAGS_c_puct, FLAGS_alpha, FLAGS_epsilon, FLAGS_max_size_memory, FLAGS_num_game_per_epoch, FLAGS_num_train_step, FLAGS_num_test, FLAGS_log_file);
